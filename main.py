# main script to be run when you want to play a game against any agent
# should not contain any code that the agents package is dependent on
...
def human_vs_agent(
    ...
    # 4 games are initiated
    # game 1 and 2: player 1 plays with X
    # game 3 and 4: player 2 plays with X
